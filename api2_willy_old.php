   ...
   if (isset($_GET["getGlobalInformationsPerMonth"])) 
	{
	    ...
	    $query3="SELECT MONTH as MONTHS ,`SOMMES` as NBRES FROM `tabglobalinformationsinstitutionsbymonth_2023` WHERE `MONTH`!=0;";
...
// 		$req->closeCursor();
	...
	if (isset($_GET["getAllFactures"])) {
		...
		include("getTabGlobalInformationsInstitutionsByMONTH.php");
